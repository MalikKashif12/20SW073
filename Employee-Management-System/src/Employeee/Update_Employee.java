...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    void showData(String s){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                t5.setText(rs.getString("id"));
                iid = rs.getString("id");
                t6.setText(rs.getString("fName"));
                t7.setText(rs.getString("phone"));
                t8.setText(rs.getString("education"));
                t9.setText(rs.getString("cnic"));
            }
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                Database.updateEmployee(iid, t1.getText(), t2.getText(), t3.getText(), t4.getText(), t5.getText(), t6.getText(), t7.getText(), t8.getText(), t9.getText());
